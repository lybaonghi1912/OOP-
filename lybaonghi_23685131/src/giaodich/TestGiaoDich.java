...
System.out.println("thành tiền trung bình của giao dich tiền tệ: "+ nf.format(tinhTrungBinhThanhTien(gdTienTe)));
System.out.println();
System.out.println("các giao dịch có đơn hơn 1 tỷ: ");
