...
public void setDonGia(double donGia) {
	if(donGia < 0)
		throw new IllegalArgumentException("đơn giá phải lớn hoặc bằng 0");
	this.donGia = donGia;
}
...
public String toString() {
	...
	return String.format("%-10s %-20s %-10s %-10d %-10s %-10s %-10s", maHang, tenHang, df.format(donGia), soLuongTon, df.format(getTienVAT()), danhGia());
}
}
